      ...
      <div className="max-w-md mx-auto px-4">
        ...
        <div className="space-y-6">
          {profile && (
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h2 className="font-bold text-lg uppercase">{t("savedProfile")}</h2>
                <Button
                  variant="ghost"
                  size="sm"
          ...
          <div className="bg-muted rounded-2xl p-6">
            <h2 className="font-bold text-lg uppercase mb-4">{t("aboutTitle")}</h2>
          ...
          <div className="bg-muted rounded-2xl p-6">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-muted-foreground flex-shrink-0 mt-0.5" />
                <div>
                  <p className="font-medium">{t("deliveryAreas")}</p>
                  <p className="text-muted-foreground">{t("deliveryAreasValue")}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Truck className="w-5 h-5 text-muted-foreground flex-shrink-0 mt-0.5" />
                <div>
                  <p className="font-medium">{t("shippingPayment")}</p>
                  <p className="text-muted-foreground">{t("shippingPaymentValue")}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-muted rounded-2xl p-6">
            <h2 className="font-bold text-lg uppercase mb-4">{t("contactTitle")}</h2>
            <div className="space-y-3 text-sm">
