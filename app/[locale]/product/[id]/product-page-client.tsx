...
export default function ProductPageClient({ product }: ProductPageClientProps) {
  ...
  const categoryLabel =
    {
      hoodies: tHome("categories.hoodies"),
      joggers: tHome("categories.joggers"),
  ...
  const handleShare = async () => {
    ...
    const shareData = {
      title: product.name,
      text: isPurchasable
        ? t("shareTextWithPrice", { name: product.name, price: formatCurrency(product.price!) })
        : t("shareText", { name: product.name }),
          ...
          <div className="px-6 py-8 lg:py-12">
            ...
            >
              ...
              >
                ...
                <p className="text-xs font-medium text-primary uppercase tracking-wider">{categoryLabel}</p>
              </motion.div>
