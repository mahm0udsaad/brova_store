...
interface YnsProductDetailConfig {
  product?: ProductInfo
      ...
      <div className="flex flex-wrap gap-2">
        {sizes.map((size, i) => (
          <span
            key={size}
            className={cn(
              "flex h-10 min-w-[2.75rem] items-center justify-center rounded-full px-4 text-sm font-medium transition-all cursor-pointer select-none",
              i === 0
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="inline-flex items-center rounded-full bg-neutral-100">
        <span className="flex h-10 w-10 items-center justify-center cursor-pointer rounded-full text-[var(--theme-foreground)] transition hover:bg-neutral-200">
          <svg
  ...
  return (
    ...
    >
      <article className="space-y-3">
        <div className="relative aspect-[4/5] overflow-hidden rounded-xl bg-neutral-50 shadow-sm transition-all group-hover:shadow-md group-hover:scale-[1.02]">
          {product.imageUrl ? (
            <Image
...
export async function YnsProductDetail({
  config,
  locale,
}: ThemeComponentProps<YnsProductDetailConfig>) {
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-14">
          ...
          <div className="flex flex-col gap-6">
            ...
            {/* Product name */}
            <h1 className="text-2xl font-bold leading-tight text-start sm:text-3xl">
              {productName}
            </h1>
            ...
            <Button
              className={cn(
                ...
                "hover:bg-[var(--theme-primary)]/90 hover:shadow-lg hover:shadow-[var(--theme-primary)]/20"
              )}
            >
